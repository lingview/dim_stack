      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <div className="update-header flex justify-between items-start mb-6 pb-5 border-b border-gray-100 gap-4">
          ...
          <button
              ...
              disabled={checking}
              className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500 text-sm text-white rounded-md hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
          >
            {checking ? (
                <>
