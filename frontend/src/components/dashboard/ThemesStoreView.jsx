        ...
        <div className="mx-auto">
            <div className="bg-white rounded-lg shadow">
                ...
                {showPreview && selectedTheme && (
                    <>
                    <div className="fixed inset-0 backdrop-blur-sm bg-transparent z-40" onClick={closePreview}></div>
                    <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
                        <div className="bg-white rounded-lg max-w-4xl w-full max-h-full overflow-auto" onClick={(e) => e.stopPropagation()}>
                            <div className="p-6">
                                <div className="flex justify-between items-start">
                                    <div>
