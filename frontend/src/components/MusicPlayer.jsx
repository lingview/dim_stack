    ...
    return (
        ...
        >
            <div className="music-player-container bg-white/80 backdrop-blur-lg rounded-r-xl shadow-xl w-64 border border-gray-200/50 border-l-0">
                <div className="absolute -right-6 top-1/2 -translate-y-1/2 bg-blue-500 text-white px-1.5 py-4 rounded-r-md shadow-md cursor-pointer hover:bg-blue-600 transition-colors flex flex-col items-center gap-1">
