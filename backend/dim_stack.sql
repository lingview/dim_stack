...
-- ----------------------------
-- Table structure for friend_links_config
-- ----------------------------
...
-- ----------------------------
-- Records of friend_links_config
-- ----------------------------
...
-- ----------------------------
-- Table structure for llm_prompt_config
-- ----------------------------
...
CREATE TABLE `site_config`  (
                                ...
                                `enable_llm` int NULL DEFAULT NULL COMMENT '是否启动系统大模型接入（1：启用，0：禁用）',
                                `enable_llm_article_review` int NULL DEFAULT NULL COMMENT '是否启用大模型自动审核文章（1：启用，0：禁用）',
                                `enable_llm_create_article` int NULL DEFAULT NULL COMMENT '是否启用大模型生成文章（1：启用，0：禁用）',
                                `global_head_code` mediumtext CHARACTER SET utf8mb4 NULL COMMENT '全局Head标签代码注入',
                                `content_head_code` mediumtext CHARACTER SET utf8mb4 NULL COMMENT '内容页Head标签代码注入',
                                `footer_code` mediumtext CHARACTER SET utf8mb4 NULL COMMENT '页脚代码注入',
                                `enable_image_compression` int NULL DEFAULT 0 COMMENT '是否启用图片压缩（1：启用，0：禁用）',
